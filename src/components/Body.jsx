                            ...
                            <div className="slider">
                                <img className="arrow" src="../img/body/arrowleft-3@2x.svg" alt=""/>
                                    <a className="card card1" href="#">
                                        <img className="card-img-size" src="../img/body/amsterdam-y.png" alt="" />
                                    </a>
                                    <a className="card card2" href="#">
                                        <img className="card-img-size" src="../img/body/moden-f.png" alt=""/>
                                    </a>
                                    <a className="card card3" href="#">
                                        <img className="card-img-size" src="../img/body/leyla-mecnun.png" alt=""/>
                                    </a>
                                    <a className="card card4" href="#">
                                        <img className="card-img-size" src="../img/body/50m2p.png" alt=""/>
                                    </a>
                                    <a className="card card5" href="#">
                                        <img className="card-img-size" src="../img/body/snow.png" alt=""/>
                                    </a>
                                    <a className="card card6" href="#">
                                        <img className="card-img-size" src="../img/body/brooklyn.png" alt=""/>
                                    </a>
                                    <a className="card card7" href="#">
                                        <img className="card-img-size" src="../img/body/yanimda2.png" alt=""/>
                                    </a>
